...
class Tool(ultimate.UltimateTool):
    ...
    REQUIRED_PATHS = [
        "artifacts.xml", "configuration", "cvc4", "features", "LICENSE",
        "LICENSE.GPL", "LICENSE.GPL.LESSER", "p2", "plugins", "README",
        ...
        "svcomp-Reach-64bit-Taipan_Default.epf", "TaipanMemDerefMemtrack.xml",
        "TaipanReach.xml", "TaipanWitnessValidation.xml", "Ultimate",
