...
class Tool(ultimate.UltimateTool):
    ...
    REQUIRED_PATHS = [
        "artifacts.xml", "configuration", "cvc4", "features",
        "KojakMemDerefMemtrack.xml", "KojakReach.xml", "LICENSE", "LICENSE.GPL",
        "LICENSE.GPL.LESSER", "p2", "plugins", "README",
        ...
        "svcomp-Reach-64bit-Kojak_Default.epf", "Ultimate", "Ultimate.ini",
        "Ultimate.py", "z3", "mathsat"
    ]
