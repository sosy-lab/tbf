...
class Tool(ultimate.UltimateTool):
    ...
    REQUIRED_PATHS = [
        "artifacts.xml", "AutomizerTermination.xml",
        "AutomizerWitnessValidation.xml", "AutomizerReach.xml",
        "AutomizerMemDerefMemtrack.xml", "configuration", "cvc4", "features",
        "LICENSE", "LICENSE.GPL", "LICENSE.GPL.LESSER", "p2", "plugins",
        "README", "svcomp-DerefFreeMemtrack-32bit-Automizer_Bitvector.epf",
        ...
        "svcomp-Termination-64bit-Automizer_Default.epf", "Ultimate",
        "Ultimate.ini", "Ultimate.py", "z3", "mathsat"
    ]
