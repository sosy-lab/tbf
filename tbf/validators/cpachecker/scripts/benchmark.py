...
class Benchmark(benchexec.benchexec.BenchExec):
    ...
    def create_argument_parser(self):
        ...
        vcloud_args = parser.add_argument_group(
            'Options for using VerifierCloud')
        ...
        vcloud_args.add_argument(
            ...
            metavar="HOST",
            help=
            "Sets the master host of the VerifierCloud instance to be used. If this is a HTTP URL, the web interface is used."
        )
        ...
        vcloud_args.add_argument(
            ...
            metavar="PRIORITY",
            help=
            "Sets the priority for this benchmark used in the VerifierCloud. Possible values are IDLE, LOW, HIGH, URGENT."
        )
        ...
        vcloud_args.add_argument(
            ...
            metavar="CPU_MODEL",
            help=
            "Only execute runs in the VerifierCloud on CPU models that contain the given string."
        )
        ...
        vcloud_args.add_argument(
            ...
            metavar="USER:PWD",
            help=
            "The user and password for the VerifierCloud (if using the web interface)."
        )
        ...
        vcloud_args.add_argument(
            ...
            help=
            "The svn revision of CPAchecker to use (if using the web interface of the VerifierCloud)."
        )
        ...
        vcloud_args.add_argument(
            ...
            action="store_true",
            help=
            "Do not run the benchmarks. Assume that the benchmarks were already executed in the VerifierCloud and the log files are stored (use --startTime to point the script to the results)."
        )
        ...
        vcloud_args.add_argument(
            ...
            type=int,
            help=
            "The heap-size (in MB) used by the VerifierCloud client. A too small heap-size may terminate the client without any results."
        )
        ...
        vcloud_args.add_argument(
            ...
            type=int,
            help=
            "The number of threads used for parallel run submission (if using the web interface of the VerifierCloud)."
        )
        ...
        vcloud_args.add_argument(
            ...
            type=int,
            help=
            "The interval in seconds for polling results from the server (if using the web interface of the VerifierCloud)."
        )
