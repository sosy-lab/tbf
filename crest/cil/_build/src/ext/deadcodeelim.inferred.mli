...
module RD :
  sig
      ...
      sig
          ...
          sig
            module E :
              sig
                ...
                val readingFromStdin : bool ref
                val startParsing :
                  ?useBasename:bool -> string -> Lexing.lexbuf
                val startParsingFromString :
                  ?file:string -> ?line:int -> string -> Lexing.lexbuf
                val finishParsing : unit -> unit
              end
        ...
        class nullAdderClass :
          object
            ...
            method vattr :
              Cil.attribute -> Cil.attribute list Cil.visitAction
            method vattrparam :
              Cil.attrparam -> Cil.attrparam Cil.visitAction
            ...
            method vinit :
              Cil.varinfo ->
              Cil.offset -> Cil.init -> Cil.init Cil.visitAction
    ...
    type rhs = Reachingdefs.rhs = RDExp of Cil.exp | RDCall of Cil.instr
    ...
    val prettyprint :
      Cil.stmt IH.t ->
      ('a * int * IOS.t IH.t) IH.t ->
      unit -> 'b * 'c * IOS.t IH.t -> Pretty.doc
    module ReachingDef :
      sig
        val name : string
        val debug : bool ref
        ...
        val doStmt :
          Cil.stmt -> 'a * 'b * 'c -> (unit * 'b * 'c) DF.stmtaction
